...
emcmake cmake $ScriptDir/temp/assimp-5.3.1 -B$ScriptDir/temp/assimp-5.3.1/build \
...
emcmake cmake $ScriptDir/temp/SDL2-2.28.5 -B$ScriptDir/temp/SDL2-2.28.5/build \
...
echo -e "\n============================================================================"
echo -e "Unpacking Bootstrap"
echo -e "============================================================================\n"

unzip -o $ScriptDir/bootstrap-5.3.3.zip -d $ScriptDir/temp > /dev/null
cp -r $ScriptDir/temp/bootstrap-5.3.3-dist/* $ScriptDir/../bootstrap
